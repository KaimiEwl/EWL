        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-slate-500">
              Творожок подсказывает и помогает с информацией.
            </p>
            <p className="mt-2 text-xs leading-5 text-slate-400">
              Важно: он ничего не делает за тебя сам. Не нажимает кнопки, не сохраняет данные и не меняет записи.
            </p>
          </div>
          <button
            type="button"
        ...
        {tab === "product" ? (
          <>
            <div className="mt-4 rounded-[1.25rem] bg-slate-50 px-4 py-3 text-sm text-slate-600">
              Напиши продукт, получи КБЖУ и нутриенты, потом открой карточку-черновик и уже сам реши, сохранять ее или править.
            </div>
            ...
            {productAnswer ? (
              <div className="theme-elevated mt-4 rounded-[1.25rem] px-4 py-3 text-sm leading-6 text-slate-700">
                <div className="font-semibold text-slate-900">Что нашел творожок</div>
                <div className="mt-2 whitespace-pre-wrap">{productAnswer}</div>
              </div>
            ) : null}
          ...
          <>
            <div className="mt-4 rounded-[1.25rem] bg-slate-50 px-4 py-3 text-sm text-slate-600">
              Спрашивай что угодно, я помогу с информацией. Но только подскажу: ничего сам за тебя в приложении не сделаю.
            </div>
