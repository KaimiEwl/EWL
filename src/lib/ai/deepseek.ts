  ...
  const content = await requestDeepSeek(apiKey, [
    {
      ...
      content:
        ...
        "Если в контексте уже есть текущие значения карточки, считай их основой и не противоречь им без явной причины. " +
        "Главная задача: аккуратно дополнить карточку и заполнить недостающие нутриенты, а не придумать другой продукт. " +
